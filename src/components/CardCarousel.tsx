  ...
  return <section className="py-16 md:py-24 px-6 bg-background">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-center mt-8">
          <button onClick={flipCard} className="flex items-center gap-2 px-6 py-3 text-primary-foreground font-sans text-sm font-medium tracking-wider uppercase hover:bg-burnt-orange-dark transition-colors duration-300 bg-[#ab4f21]">
            <RotateCw size={16} />
            Flip Card
          </button>
        </div>
