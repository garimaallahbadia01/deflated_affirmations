...
const Hero = () => {
  ...
  return (
    <section className="relative w-full h-screen min-h-[500px] overflow-hidden">
      ...
      <div 
        className="absolute left-0 bottom-0 h-[75%] md:h-[85%] lg:h-[90%] pointer-events-none"
      ...
      <div 
        className="absolute right-0 bottom-0 h-[75%] md:h-[85%] lg:h-[90%] pointer-events-none"
        style={{ transform: `translateY(${scrollY * 0.15}px)` }}
      >
